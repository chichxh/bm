	...
	<div class="container-fluid mt-5">
		<div class="row py-5">
			<div class="col-6 mx-auto">
				...
				<p>Система которая поможет предприниателям разных сфер  узнавать спрос потребителей в разных районах. Напишите письмо с описанием сферы деятельности, которой вам не хватает. И есть шанс, что заинтересовавшийся предпрениматель откроет точку в вашем указанном месте</p>
			</div>
