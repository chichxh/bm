...
<body>
	...
	<div class="container-fluid mt-5">
		...
		<div class="row py-5 yellow">
			<div class="col-5 mx-auto">
				<h1><b>Чем сайт помогает <br> предпринимателям?</b></h1>
				<p>Карта сайта включает в себя плотность предпринимательской деятельности, также и их критерии.</p>
			</div>
			<div class="col-6">
		...
		<div class="row py-5 yellow">
			...
			<div class="col-5 mx-auto">
				<h1 class="text-end"><b>Выбирайте свой район</b></h1>
				<p class="text-end">Карта сайта включает в себя плотность предпринимательской деятельности, также и их критерии. </p>
			</div>
		</div>
		<div class="row py-5 white">
			<div class="col-5 mx-auto">
				<h1><b>Возможности потребителя в сайте </b></h1> <br>
				<p>Сайт был разработан с целью упростить мониторинг предпринимательской деятельности. Сайт поможет не только мониторингу, но и самим предпринимателем и потребителям.</p>	
			</div>
			<div class="col-6 text-center">
    ...
    <div id="map">
        ...
        function pop_1000_0(feature, layer) {
            ...
            var popupContent = '<table>\
                    ...
                    <tr>\
                        <td><a href="hangalassky.php">Подробнее</a></td>\
                    </tr>\
                </table>';
