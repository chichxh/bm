	...
	<div class="container-fluid yellow">
		<div class="row py-5 ">
			...
			<div class="col-7 mx-auto text-end">
				...
				<p>Карта сайта включает в себя плотность предпринимательской деятельности, также и их критерии. </p> <br>
	...
	<div class="container">
		<div class="row py-5 white">
			<div class="col-6 mx-auto">
				...
				<p>Сайт был разработан с целью упростить мониторинг предпринимательской деятельности. Сайт поможет не только мониторингу, но и самим предпринимателем и потребителям.</p> <br>
			</div>
			<div class="col-6 text-center">
